...
class Router : public EnhancedEventEmitter {
     ...
     * @emits @close
     */
	Router({ internal, data, channel, appData }) {
        super();
        // Closed flag.
        this->_closed = false;
        // Transports map.
     ...
     */
    async createWebRtcTransport({ listenIps, enableUdp = true, enableTcp = false, preferUdp = false, preferTcp = false, initialAvailableOutgoingBitrate = 600000, enableSctp = false, numSctpStreams = { OS: 1024, MIS: 1024 }, maxSctpMessageSize = 262144, appData = {} }) {
     ...
     */
    async createPlainTransport({ listenIp, rtcpMux = true, comedia = false, enableSctp = false, numSctpStreams = { OS: 1024, MIS: 1024 }, maxSctpMessageSize = 262144, enableSrtp = false, srtpCryptoSuite = "AES_CM_128_HMAC_SHA1_80", appData = {} }) {
     ...
     */
    async createPipeTransport({ listenIp, enableSctp = false, numSctpStreams = { OS: 1024, MIS: 1024 }, maxSctpMessageSize = 1073741823, enableRtx = false, enableSrtp = false, appData = {} }) {
