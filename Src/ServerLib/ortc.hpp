 ...
 */
function validateRtpCapabilities(caps: RtpCapabilities): void
{
 ...
 * It throws if invalid.
 */
function validateRtpParameters(params: RtpParameters): void
{
 ...
 * It throws if invalid.
 */
function validateSctpCapabilities(caps: SctpCapabilities): void
{
	if (typeof caps !== "object")
		throw new TypeError("caps is not an object");
 ...
 * It throws if invalid.
 */
function validateSctpParameters(params: SctpParameters): void
{
	if (typeof params !== "object")
		throw new TypeError("params is not an object");
 ...
 * It throws if invalid.
 */
function validateSctpStreamParameters(params: SctpStreamParameters): void
{
	if (typeof params !== "object")
		throw new TypeError("params is not an object");
 ...
 */
function getProducerRtpParametersMapping(
 ...
 */
function getConsumableRtpParameters(
	kind: string,
	params: RtpParameters,
	caps: RtpCapabilities,
 ...
 */
function getPipeConsumerRtpParameters(
	consumableParams: RtpParameters,
	enableRtx = false
): RtpParameters
{
