 ...
 */
task_t<void> RtpObserver::resume()
{
	MSC_DEBUG("resume()");
 ...
 */
task_t<void> RtpObserver::addProducer(std::string producerId)
{
 ...
 */
task_t<void> RtpObserver::removeProducer(std::string producerId)
{
